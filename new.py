...
dmap = pd.read_csv("https://raw.githubusercontent.com/ShakriyaPanday/vayu/refs/heads/main/pollution.csv")
# Footer
...
# API URL
API_URL = "https://api.airgradient.com/public/api/v1/world/locations/72192/measures/current"
data = [
